            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="company.employees.label" default="Employees" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="company.products.label" default="Products" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="company.purchaseOrders.label" default="Purchase Orders" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${companyInstance.purchaseOrders}" var="p">
